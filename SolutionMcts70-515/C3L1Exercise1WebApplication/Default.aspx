...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Label ID="lblLogon" Text="Logon as:" runat="server" />
    <asp:DropDownList ID="ddlUserType" runat="server" AutoPostBack="true" 
        oninit="ddlUserType_Init" onload="ddlUserType_Load" 
        onprerender="ddlUserType_PreRender">
    ...
    <asp:Label ID="lblUserName" Text="User:" runat="server" />
